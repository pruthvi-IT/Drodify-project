...
class BookingHistoryCanceled extends StatelessWidget {
  const BookingHistoryCanceled({super.key});
          ...
          children: [
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  _BookingCard(
                    image: 'assets/images/La Belle  Vie Hotel.png',
                    hotelName: 'La Belle Vie Hotel',
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _SingleTab(text: 'Canceled', selected: true),
        ],
      ),
    );
  }
